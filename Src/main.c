  ...
  while(1) {
    ...
    // ####### FEEDBACK SERIAL OUT #######
      ...
      if (main_loop_counter % 2 == 0) {    // Send data periodically every 10 ms
        ...
        Feedback.MechR          =  (int16_t)rtU_Right.a_mechAngle;
        Feedback.MechL          =  (int16_t)rtU_Left.a_mechAngle;
        ...
        Feedback.boardTemp	    = (int16_t)board_temp_deg_c;
          ...
          if(__HAL_DMA_GET_COUNTER(huart3.hdmatx) == 0) {
            ...
            Feedback.checksum   = (uint16_t)(Feedback.start ^ Feedback.EAR^ Feedback.MechR ^ Feedback.MechL ^ Feedback.EAL ^ Feedback.uR ^ Feedback.vR ^ Feedback.wR ^ Feedback.uL ^ Feedback.vL ^ Feedback.wL ^ Feedback.cmd1 ^ Feedback.cmd2 ^ Feedback.speedR_meas ^ Feedback.speedL_meas 
                                           ^ Feedback.batVoltage ^ Feedback.boardTemp ^ Feedback.cmdLed);
